...
public class RedisTemplate {
	...
	/**
	 * 取key的 startOffset 与endOffset 之间的值
	 * @param key
	 * @param startOffset
	 * @param endOffset
	 * @return
	...
	/**
	 * decrement the number stored at key by the integer
	...
	/**
	 *  Increment the number stored at key by the integer
	 * If the key does not exist or contains a value of a wrong type,
	 * set the key to the value of "0" before to perform the increment operation.
	 * @param key
	 * @param integer
	 ...
	 * If key does not exist, a new key holding a hash is created. If field does not exist or holds a string,
